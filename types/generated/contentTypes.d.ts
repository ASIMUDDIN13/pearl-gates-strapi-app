...
export interface ApiAboutSectionAboutSection
  ...
  info: {
    description: 'Info boxes shown in the About Us page';
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client and partner logos shown in the clients carousel';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiHotOfferHotOffer extends Struct.SingleTypeSchema {
  collectionName: 'hot_offer';
  info: {
    description: 'The featured hot offer of the day shown on the homepage';
    displayName: 'Hot Offer';
...
export interface ApiMissionPointMissionPoint
  extends Struct.CollectionTypeSchema {
  collectionName: 'mission_points';
  info: {
    description: 'Individual mission points shown in the Our Mission section';
    displayName: 'Mission Point';
    pluralName: 'mission-points';
    singularName: 'mission-point';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mission-point.mission-point'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services offered by The Pearl Gates';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration for The Pearl Gates';
  ...
  attributes: {
    ...
    contact_map_lat: Schema.Attribute.Decimal;
    contact_map_lng: Schema.Attribute.Decimal;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_about_text: Schema.Attribute.Text;
    footer_contact_address: Schema.Attribute.Text;
    footer_contact_email: Schema.Attribute.Email;
    footer_contact_phone: Schema.Attribute.String;
    ...
    header_style: Schema.Attribute.Enumeration<
    ...
    hero_slides: Schema.Attribute.JSON;
    ...
    mission_points: Schema.Attribute.JSON;
    ...
    top_bar_address: Schema.Attribute.String;
    top_bar_email: Schema.Attribute.Email;
    top_bar_phone: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
